...
var handleScrollToTopButton = function() {
  ...
  document.onscroll = function() {
    ...
    var elmList2 = elmTriggerList.map(function(elm2) {
      if (totalScroll >= app.scrollToTopBtn.heightShow) {
        if (!elm2.classList.contains(app.scrollToTopBtn.showClass)) {
          elm2.classList.add(app.scrollToTopBtn.showClass);
        }
      } else {
        elm2.classList.remove(app.scrollToTopBtn.showClass);
      }
    });
...
var handleThemePanel = function() {
  ...
  elmList.map(function(elm2) {
    elm2.onclick = function(e) {
      e.preventDefault();
  ...
  elmList.map(function(elm2) {
    elm2.onclick = function() {
      ...
      targetThemeList.map(function(targetElm2) {
        if (targetElm2.getAttribute(app.themePanel.theme.classAttr) != targetTheme) {
          targetElm2.closest("." + app.themePanel.themeListItemCLass).classList.remove(app.themePanel.theme.activeClass);
        }
      });
  ...
  elmList.map(function(elm2) {
    elm2.onclick = function(e) {
      ...
      targetCoverList.map(function(targetElm2) {
        if (targetElm2.getAttribute(app.themePanel.themeCover.toggleAttr) != targetTheme) {
          targetElm2.closest("." + app.themePanel.themeCoverItemClass).classList.remove(app.themePanel.themeCover.activeClass);
        }
      });
