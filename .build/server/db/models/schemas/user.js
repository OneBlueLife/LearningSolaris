...
const schema = new Schema({
  ...
  gameSettings: {
    ...
    map: {
      ...
      background: {
        ...
        nebulaOpacity: { type: Types.Number, required: false, default: 1, min: 0, max: 1 },
        moveNebulas: { type: Types.String, required: false, enum: ["enabled", "disabled"], default: "enabled" },
        nebulaMovementSpeed: { type: Types.Number, required: false, default: 1, min: 0, max: 2 },
        starsOpacity: { type: Types.Number, required: false, default: 1, min: 0, max: 1 },
  ...
  subscriptions: {
    settings: {
      notifyActiveGamesOnly: { type: Types.Boolean, required: false, default: false }
    },
    discord: {
