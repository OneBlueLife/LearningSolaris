...
__export(spectator_exports, {
  spectatorInviteSpectatorRequestSchema: () => spectatorInviteSpectatorRequestSchema
});
module.exports = __toCommonJS(spectator_exports);
var Joi = __toESM(require("joi"));
const spectatorInviteSpectatorRequestSchema = Joi.object({
  username: Joi.string().required().min(3).max(24)
});
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  spectatorInviteSpectatorRequestSchema
});
