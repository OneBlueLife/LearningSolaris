...
describe("star", () => {
  let starService;
  beforeEach(() => {
    starService = new import_star.default({}, fakeRandomService, fakeStarNameService, fakeDistanceService, fakeStarDistanceService);
  });
  ...
  it("should calculate terraformed resources", () => {
    ...
    const result1 = starService.calculateTerraformedResources(star1, 5);
    const result2 = starService.calculateTerraformedResources(star2, 2);
