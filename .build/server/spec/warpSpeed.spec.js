...
var import_carrierMovement = __toESM(require("../services/carrierMovement"));
const mongoose = require("mongoose");
let playerId, carrierId, sourceStarId, destinationStarId;
let game, player, carrier, sourceStar, destinationStar, starSpecialist, carrierSpecialist, isFormalAlliancesEnabled, isDiplomaticStatusToPlayersAllied;
let gameRepo, distanceService, specialistService, diplomacyService, starService, carrierGiftService;
specialistService = {
  getByIdStar() {
...
describe("warp speed", () => {
  const service = new import_carrierMovement.default(gameRepo, distanceService, starService, specialistService, diplomacyService, carrierGiftService);
  beforeEach(() => {
...
//# sourceMappingURL=warpSpeed.spec.js.map
